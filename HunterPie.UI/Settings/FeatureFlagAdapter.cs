...
public static class FeatureFlagAdapter
{
    ...
    public static ObservableCollection<ConfigurationCategory> Adapt(Dictionary<string, IFeature> flags)
    {
        ...
        return new ObservableCollection<ConfigurationCategory> { category };
    }
}